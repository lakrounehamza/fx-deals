...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleDealValidationException(InvalidDealDataException ex) {
        Map<String, Object> body = new HashMap<>();
        body.put("timestamp", LocalDateTime.now());
        body.put("status", HttpStatus.BAD_REQUEST.value());
    ...
    public ResponseEntity<Object> handleDuplicateDealException(DuplicateDealException ex) {
        Map<String, Object> body = new HashMap<>();
        body.put("timestamp", LocalDateTime.now());
